          ...
          <div class="col-md-8">
            <div class="hero-container">
                <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                    ...
                    <!-- Slide 1 -->
                    <div class="carousel-item rounded active" style="background-image: url('{{ asset('mamba/assets/img/slide/slide-1.jpg') }}');">
                    ...
                    <!-- Slide 2 -->
                    <div class="carousel-item rounded" style="background-image: url('{{ asset('mamba/assets/img/slide/slide-2.jpg') }}');">
                        <div class="carousel-container" style="height: 550px">
                            <div class="carousel-content container">
                    ...
                    <!-- Slide 3 -->
                    <div class="carousel-item rounded" style="background-image: url('{{ asset('mamba/assets/img/slide/slide-3.jpg') }}');">
                        <div class="carousel-container" style="height: 550px">
                            <div class="carousel-content container">
