        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Tag Article</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.article.tags.store', $article->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
