...
<body>
  ...
  <div class="container">
    <div style="margin-top: 100px; margin-bottom: 20px;">
      ...
      text-align:center;"
      >
      Pantau terus untuk berita dan artikel terbaru yang membahas seputar dunia arsitektur dan lorem ipsum dolor sit amet, consectetur </p>
    </div>
  </div>
    ...
    <div class="container">
        ...
        <div class="col-md-3 mb-3">
          <div class="card shadow" style="width: 100%; height: 100%; border: none">
            <img src="{{ asset('images/'.$value->cover_image) }}" class="card-img-top" alt="...">
            <div class="card-body">
              <p>{{$value->topic}}</p>
              <a style="text-decoration: none" href="{{ route('article.detail', $value->slug_title) }}">
                <h5 class="card-title">{{$value->title}}</h5>
              </a>
              <p>{!! substr(strip_tags($value->description), 0, 50) !!}</p>
            </div>
          </div>
        </div>
        @endforeach
